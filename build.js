...
const assets = [
    [`${path.join(__dirname, './index.html')}`, '/index', 'html'],
    [`${path.join(__dirname, './assets/css/style.css')}`, '/style', 'css'],
    [`${path.join(__dirname, './assets/js/_main.js')}`, '/_main', 'js'],
    [`${path.join(__dirname, './assets/js/alertClick.js')}`, '/alertClick', 'js'],
    [`${path.join(__dirname, './assets/js/alertCorrect.js')}`, '/alertCorrect', 'js'],
    [`${path.join(__dirname, './assets/js/alertWrong.js')}`, '/alertWrong', 'js'],
    [`${path.join(__dirname, './assets/js/checkAnswer.js')}`, '/checkAnswer', 'js'],
    [`${path.join(__dirname, './assets/js/checkGoalColor.js')}`, '/checkGoalColor', 'js'],
    [`${path.join(__dirname, './assets/js/resetEasy.js')}`, '/resetEasy', 'js'],
    [`${path.join(__dirname, './assets/js/resetGame.js')}`, '/resetGame', 'js'],
    [`${path.join(__dirname, './assets/js/resetHard.js')}`, '/resetHard', 'js'],
    [`${path.join(__dirname, './assets/js/setBackground.js')}`, '/setBackground', 'js'],
    [`${path.join(__dirname, './assets/js/setColor.js')}`, '/setColor', 'js'],
    [`${path.join(__dirname, './assets/js/setGame.js')}`, '/setGame', 'js'],
    [`${path.join(__dirname, './assets/js/setSpecialBoxes.js')}`, '/setSpecialBoxes', 'js']
]
...
const others = [
    [`${path.join(__dirname, './assets/fonts')}`, `${outputDir_main}${outputDir_sub}/fonts`],
    [`${path.join(__dirname, './assets/sounds')}`, `${outputDir_main}${outputDir_sub}/sounds`],
